...
#pragma warning restore CA2227 // Collection properties should be read only
        ...
        public bool CheckMic(NetworkSessionKey key, uint? server32BitFcnt = null)
        {
            ...
            return Mic == MessageIntegrityCode.ComputeForData(key, (byte)Direction, DevAddr, fcnt, byteMsg);
        }
        ...
        public void SetMic(NetworkSessionKey nwskey)
        {
            ...
            var fcnt = this.server32BitFcnt ?? Fcnt;
            Mic = MessageIntegrityCode.ComputeForData(nwskey, (byte)Direction, DevAddr, fcnt, byteMsg);
